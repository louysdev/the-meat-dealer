...
export const Header: React.FC<HeaderProps> = ({ 
  ...
  return (
    <header className="bg-gradient-to-r from-red-900 to-red-800 shadow-2xl relative z-50">
      ...
      <div className={`md:hidden absolute top-full left-0 right-0 bg-gradient-to-r from-red-900 to-red-800 border-t border-red-700/50 shadow-2xl z-50 transform transition-all duration-300 ease-in-out ${
        isMobileMenuOpen 
